...
export default class News extends Component {
    ...
    fetchNews = async () => {
        let url = `https://news-daily-xi.vercel.app/api/news?searchQuery=${this.props.searchQuery}&country=${this.props.country}&category=${this.props.category}&page=${this.state.page}&pageSize=${this.props.pageSize}`;
        try {
